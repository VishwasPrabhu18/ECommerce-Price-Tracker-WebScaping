    ...
    <div className='product-container'>
      <div className='flex gap-28 xl:flex-row flex-col'>
        ...
        <div className='flex-1 flex flex-col'>
          <div className='flec justify-between items-start gap-5 flex-wrap pb-6'>
            ...
            <div className='flex items-center gap-3'>
              <div className='product-hearts'>
                <Image
                  ...
                  height={20}
                />
                <p className='text-base font-semibold text-[#D46F77]'>{product.reviewsCount || 0}</p>
              </div>
              ...
              <div className='flex gap-3'>
                ...
                <div className='product-reviews'>
                  <Image
                    ...
                    height={16}
                  />
                  <p className='text-sm text-secondary font-semibold'>{product.reviewsCount || 0} Reviews</p>
                </div>
              </div>
